      ...
      <div className="about-grid">
        <div className="about-grid-info">
          <p className="about-grid-info-text">
            My name is Hardik, and I am passionate about creating
            digital content for the web. My interest in Fullstack Development. 
          </p>
          {/* <p className="about-grid-info-text">
          ...
          <ul className="about-grid-info-list">
            ...
            <li className="about-grid-info-list-item">Jacascript</li>
        ...
        <div className="about-grid-photo">
          ...
          <div className="overlay-border"></div>
           ...
           <div style={{ position: 'relative', width: '100%', height: 'auto', maxHeight: '600px', overflow: 'hidden' }}>
    <img
      src="https://img.freepik.com/premium-photo/man-sits-cube-with-laptop-his-hands_81048-4510.jpg?w=740"
      alt="profile"
