...
function Experience() {
  ...
  const expereinces = [
    {
      ...
      url: "https://zinikus.com/",
      start: "January 12",
      end: "May  17",
      shortDescription: [
        "Developing User Interface: Coded responsive web design in React, increasing website load speed by 20%",
        "Optimizing Web Performance: Writing efficient, clean, and maintainable code. Working with frontend framework: Using frameworks and libraries like React Next-Js..",
        "Debugging and Testing: Identifying and troubleshooting UI/UX – Frontend issues",
  ...
  //     url: "https://www.youtube.com/@CodewithAnsh-fo7bd",
  //     start: "April 2024",
  //     end: "Present",
  //     shortDescription: [
